...
class CarSensorsProxy {
    ...
    private final Handler mHandler = new Handler() {
        public void handleMessage(Message message) {
            Collection<OnSensorChangedListener> collection;
            switch (message.what) {
                case 1:
                    int i = message.arg1;
                    synchronized (CarSensorsProxy.this) {
                    ...
                    if (carSensorEvent != null) {
                        for (OnSensorChangedListener onSensorChanged : collection) {
    ...
    /* access modifiers changed from: private */
    public final Map<Integer, Set<OnSensorChangedListener>> mListenersMultiMap;
    ...
    private final SensorEventListener mSensorListener = new SensorEventListener() {
        ...
        public void onSensorChanged(android.hardware.SensorEvent r7) {
            ...
            L_0x0026:
                ...
                r0.mLastGyroscopeDataTime = r2     // Catch:{ all -> 0x0046 }
                android.support.car.hardware.CarSensorsProxy r0 = android.support.car.hardware.CarSensorsProxy.this     // Catch:{ all -> 0x0046 }
                r2 = 18
            ...
            L_0x0049:
                ...
                android.support.car.hardware.CarSensorsProxy r0 = android.support.car.hardware.CarSensorsProxy.this     // Catch:{ all -> 0x0046 }
                long r2 = java.lang.System.nanoTime()     // Catch:{ all -> 0x0046 }
                r0.mLastMagneticFieldDataTime = r2     // Catch:{ all -> 0x0046 }
                android.support.car.hardware.CarSensorsProxy r0 = android.support.car.hardware.CarSensorsProxy.this     // Catch:{ all -> 0x0046 }
                r2 = 1
                r0.pushSensorChanges(r2)     // Catch:{ all -> 0x0046 }
                goto L_0x0044
            L_0x0067:
                ...
                android.support.car.hardware.CarSensorsProxy r0 = android.support.car.hardware.CarSensorsProxy.this     // Catch:{ all -> 0x0046 }
                long r2 = java.lang.System.nanoTime()     // Catch:{ all -> 0x0046 }
                r0.mLastAccelerometerDataTime = r2     // Catch:{ all -> 0x0046 }
                android.support.car.hardware.CarSensorsProxy r0 = android.support.car.hardware.CarSensorsProxy.this     // Catch:{ all -> 0x0046 }
                r2 = 14
                r0.pushSensorChanges(r2)     // Catch:{ all -> 0x0046 }
                android.support.car.hardware.CarSensorsProxy r0 = android.support.car.hardware.CarSensorsProxy.this     // Catch:{ all -> 0x0046 }
                ...
                goto L_0x0044
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.car.hardware.CarSensorsProxy.AnonymousClass3.onSensorChanged(android.hardware.SensorEvent):void");
        }
    };
    ...
    private CarSensorEvent createGpsStatusCarSensorEvent(GpsStatus gpsStatus) {
        ...
        for (GpsSatellite gpsSatellite : gpsStatus.getSatellites()) {
            int i5 = (i4 * 4) + 0;
            carSensorEvent.floatValues[i5 + 0] = (float) gpsSatellite.getPrn();
            ...
            carSensorEvent.intValues[(i4 * 1) + 2] = gpsSatellite.usedInFix() ? 1 : 0;
            i4++;
        }
    ...
    private android.support.car.hardware.CarSensorEvent getSensorEvent(int r8) {
        ...
        L_0x0021:
            ...
            r6 = 0
            r1 = r8
            r0.<init>(r1, r2, r4, r5, r6)     // Catch:{ all -> 0x010d }
            float[] r1 = r7.mR     // Catch:{ all -> 0x0082 }
            float[] r2 = r7.mI     // Catch:{ all -> 0x0082 }
    ...
    private void updateSensorListeners() {
        ...
        if (!keySet.contains(Integer.valueOf(10)) || !this.mLocationManager.isProviderEnabled("gps")) {
            this.mLocationManager.removeUpdates(this.mLocationListener);
        } else {
            this.mLocationManager.requestLocationUpdates("gps", 0, 0.0f, this.mLocationListener);
        }
        if (keySet.contains(Integer.valueOf(17))) {
            this.mLocationManager.addGpsStatusListener(this.mGpsStatusListener);
        } else {
            this.mLocationManager.removeGpsStatusListener(this.mGpsStatusListener);
        }
        if (keySet.contains(Integer.valueOf(14)) || keySet.contains(Integer.valueOf(1))) {
        ...
        if (keySet.contains(Integer.valueOf(1))) {
        ...
        if (keySet.contains(Integer.valueOf(18))) {
    ...
    public boolean registerSensorListener(OnSensorChangedListener onSensorChangedListener, int i, int i2) {
        boolean z;
        synchronized (this) {
            ...
            ((Set) this.mListenersMultiMap.get(Integer.valueOf(i))).add(onSensorChangedListener);
        }
        pushSensorChanges(i);
        if (z) {
    ...
    public void unregisterSensorListener(OnSensorChangedListener onSensorChangedListener) {
        if (onSensorChangedListener != null) {
            HashSet<Integer> hashSet = new HashSet<>();
            synchronized (this) {
                for (Entry entry : this.mListenersMultiMap.entrySet()) {
                    if (((Set) entry.getValue()).contains(onSensorChangedListener)) {
                        ((Set) entry.getValue()).remove(onSensorChangedListener);
                    }
    ...
    public void unregisterSensorListener(OnSensorChangedListener onSensorChangedListener, int i) {
        boolean z;
        if (onSensorChangedListener != null) {
            synchronized (this) {
                Set set = (Set) this.mListenersMultiMap.get(Integer.valueOf(i));
                if (set != null) {
