...
public class CarAudioManagerEmbedded extends CarAudioManager {
    private static final AudioFormat AUDIO_RECORD_FORMAT = new Builder().setEncoding(2).setChannelMask(16).setSampleRate(SAMPLING_RATE).build();
    ...
    public void abandonAudioFocus(OnAudioFocusChangeListener onAudioFocusChangeListener, AudioAttributes audioAttributes) {
    ...
    public int requestAudioFocus(OnAudioFocusChangeListener onAudioFocusChangeListener, AudioAttributes audioAttributes, int i) throws CarNotConnectedException, IllegalArgumentException {
        try {
    ...
    public int requestAudioFocus(OnAudioFocusChangeListener onAudioFocusChangeListener, AudioAttributes audioAttributes, int i, int i2) throws CarNotConnectedException, IllegalArgumentException {
        try {
