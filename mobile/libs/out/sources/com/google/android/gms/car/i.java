...
public final class i {
    List<Fragment> a;
    SimpleArrayMap<String, LoaderManager> b;

    public static void a(Context context, String str, boolean z) throws NameNotFoundException {
        if (str.equals("com.google.android.projection.bumblebee") || str.equals("com.google.android.projection.gearhead")) {
            ...
            if (!signature2.equals(signature)) {
                ...
                throw new SecurityException(new StringBuilder(String.valueOf(str).length() + 91 + String.valueOf(str2).length()).append(str).append(" is not signed by Google or is not allowed on this device type ").append(str2).append(" Will not load code from it.").toString());
            }
            return;
        }
        String valueOf = String.valueOf(str);
        throw new IllegalArgumentException(valueOf.length() != 0 ? "Unexpected package name ".concat(valueOf) : new String("Unexpected package name "));
    }
}
